...
namespace CreateTableClassesFromFacebookPages
{
    ...
    {
		private const string AppId = "231464590266507";
        ...
        private void TakeLoggedInAction(FacebookOAuthResult facebookOAuthResult)
        {
            ...
            if (facebookOAuthResult.IsSuccess)
            {
				...
				CreateTableClassesFromFacebookPages.doit(facebookOAuthResult.AccessToken);
				MessageBox.Show("Was able to create classes");
